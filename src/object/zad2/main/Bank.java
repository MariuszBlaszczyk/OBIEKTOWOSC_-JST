package object.zad2.main;

import object.zad2.model.Address;
import object.zad2.model.BankAccount;
import object.zad2.model.Client;
...
public class Bank {
    ...
    public static void main(String[] args) {
        ...
        if (account1.equals(account2)) {
            System.out.println("Bank accounts are identical");
        } else {
